...
def get_filters():
    ...
    while True:
        city_name = input("Choose one of those citys: chicago, new york city, washington\n")
        if city_name.lower() in CITY_DATA:
            #Take the name of the city to analyze data.
    ...
    while True:
        month_name = input("choose one of: january, february , march, april, may, june or all\n")
        if month_name.lower() in MONTH_DATA:
            #Take the name of the month to analyze data.
    ...
    while True:
        day_name = input("choose a day or all \n>")
...
def load_data(city, month, day):
    ...
    # separate month,day,hour from start time
    ...
    # filter the month 
    if month != 'all':
        # use the index for month to convert it to int
